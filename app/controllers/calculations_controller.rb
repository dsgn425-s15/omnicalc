...
# Convert annual rate to monthly and make it
r=@apr / 1200
...
d = 1 - (1 + r)**-(@years*12)
  ...
  def descriptive_statistics
    ...
    sum_sq = @numbers.inject(0){|temp_sum, x| temp_sum + (x-@mean)**2}
    @variance = sum_sq/@count-1).to_f
    ...
    @mode = @numbers.max_by{|x| mode_hash[x]}
end
end
